...
class LocalGeocodingService(GeocodingService):
    places = {
        ...
        "veteran": GeocodingResult("Jl. Veteran, Ketawanggede, Malang", -7.9554, 112.6157, "local"),
        ...
        "s supriadi": GeocodingResult("Jl. S. Supriadi, Sukun, Malang", -8.0047, 112.6151, "local"),
        "supriadi": GeocodingResult("Jl. S. Supriadi, Sukun, Malang", -8.0047, 112.6151, "local"),
        "sukun": GeocodingResult("Sukun, Malang", -8.0047, 112.6151, "local"),
        "ahmad yani": GeocodingResult("Jl. Ahmad Yani, Blimbing, Malang", -7.9396, 112.6378, "local"),
        "kawi": GeocodingResult("Jl. Kawi Atas, Gading Kasri, Malang", -7.9756, 112.6238, "local"),
        "gading kasri": GeocodingResult("Gading Kasri, Klojen, Malang", -7.9748, 112.6249, "local"),
        "sulfat": GeocodingResult("Jl. Simpang Sulfat Selatan, Purwantoro, Malang", -7.9466, 112.6487, "local"),
        "purwantoro": GeocodingResult("Purwantoro, Blimbing, Malang", -7.9466, 112.6487, "local"),
        "kolonel sugiono": GeocodingResult("Jl. Kolonel Sugiono, Gadang, Malang", -8.0012, 112.6329, "local"),
        "gadang": GeocodingResult("Gadang, Sukun, Malang", -8.0012, 112.6329, "local"),
        "muharto": GeocodingResult("Jl. Muharto, Kotalama, Malang", -7.9861, 112.6427, "local"),
        "kotalama": GeocodingResult("Kotalama, Kedungkandang, Malang", -7.9861, 112.6427, "local"),
        "la sucipto": GeocodingResult("Jl. Laksda Adi Sucipto, Pandanwangi, Malang", -7.9329, 112.6474, "local"),
        "adi sucipto": GeocodingResult("Jl. Laksda Adi Sucipto, Pandanwangi, Malang", -7.9329, 112.6474, "local"),
        "pandanwangi": GeocodingResult("Pandanwangi, Blimbing, Malang", -7.9329, 112.6474, "local"),
        "candi panggung": GeocodingResult("Jl. Candi Panggung, Mojolangu, Malang", -7.9362, 112.6157, "local"),
        "mojolangu": GeocodingResult("Mojolangu, Lowokwaru, Malang", -7.9362, 112.6157, "local"),
        "langsep": GeocodingResult("Jl. Raya Langsep, Pisang Candi, Malang", -7.9739, 112.6068, "local"),
        "pisang candi": GeocodingResult("Pisang Candi, Sukun, Malang", -7.9739, 112.6068, "local"),
        "mt haryono": GeocodingResult("Jl. MT Haryono, Dinoyo, Malang", -7.9468, 112.6099, "local"),
        "jakarta": GeocodingResult("Jl. Jakarta, Penanggungan, Malang", -7.9581, 112.6188, "local"),
        "penanggungan": GeocodingResult("Penanggungan, Klojen, Malang", -7.9581, 112.6188, "local"),
        "borobudur": GeocodingResult("Jl. Terusan Borobudur, Mojolangu, Malang", -7.9348, 112.6261, "local"),
        "arjuno": GeocodingResult("Jl. Arjuno, Kauman, Malang", -7.9793, 112.6273, "local"),
        "kauman": GeocodingResult("Kauman, Klojen, Malang", -7.9793, 112.6273, "local"),
        "candi mendut": GeocodingResult("Jl. Candi Mendut, Blimbing, Malang", -7.9386, 112.6296, "local"),
        "sudimoro": GeocodingResult("Jl. Sudimoro, Lowokwaru, Malang", -7.9349, 112.6104, "local"),
    }
